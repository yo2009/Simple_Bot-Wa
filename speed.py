...
def shell():
    ...
    if not args.mini:
        printer('📑 Recuperando la lista de servidores de speedtest.net...', quiet)
        try:
        ...
        if args.server and len(args.server) == 1:
            printer('📰 Recuperación de información para el servidor seleccionado...', quiet)
        else:
            printer('🔎 Seleccionando el mejor servidor...', quiet)
    ...
    if args.download:
        ...
        printer('*📫 Descarga | Bajada:* %0.2f M%s/s' %
